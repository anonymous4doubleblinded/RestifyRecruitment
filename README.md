 ...
 * Access docs: [http://127.0.0.1:8000/~secretidentifier/recruitment](http://127.0.0.1:8000/~secretidentifier/recruitment)
 ...
 * Theme adjustments:
   ...
   * University Red: ```docs/stylesheets/extra.css```  
```css
